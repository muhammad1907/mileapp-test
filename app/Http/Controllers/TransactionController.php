...
class TransactionController extends Controller
{
    ...
    {
        $transactions = TransactionCollection::with('customerAttribute', 'connote', 'originData', 'destinationData', 'koliData', 'customField', 'currentLocation')->get();
    ...
    {
        $transactions = TransactionCollection::with('customerAttribute', 'connote', 'originData', 'destinationData', 'koliData', 'customField', 'currentLocation')->where('transaction_id', $id)->get();
    ...
    {
        $transactions = TransactionCollection::find($id);

        if (!$transactions) {
            return response()->json(['message' => 'Transaction not found'], 404);
        }

        $transactions->customer_code = $request->customer_code;
        $transactions->transaction_amount = $request->transaction_amount;
        $transactions->transaction_discount = $request->transaction_discount;
        $transactions->transaction_additional_field = $request->transaction_additional_field;
        $transactions->transaction_payment_type = $request->transaction_payment_type;
        $transactions->transaction_state = $request->transaction_state;
        $transactions->transaction_code = $request->transaction_code;
        $transactions->transaction_order = $request->transaction_order;
        $transactions->location_id = $request->location_id;
        $transactions->organization_id = $request->organization_id;
        $transactions->transaction_payment_type_name = $request->transaction_payment_type_name;
        $transactions->transaction_cash_amount = $request->transaction_cash_amount;
        $transactions->transaction_cash_change = $request->transaction_cash_change;
    ...
    {
        TransactionCollection::where('_id', $id)->delete();

...
class PackageControllerTest extends TestCase
{
    ...
    public function testCreatePackage()
    {
        ...
        $response = $this->json('POST', '/api/package', $data);
    ...
    public function test_can_delete_product_by_id()
    {
        ...
        $response->assertStatus(200);
        $this->assertDeleted('transaction_collection', ['id' => 'd0090c40-539f-479a-8274-899b9970bddc']);
    }
    



    public function test_can_update_transaction_by_id_using_put()
    {
        $data = [
            'transaction_id'=> 'd0090c40-539f-479a-8274-899b9970bddc',
            'customer_name'=> 'PT. AMARA PRIMATIGA',
        ...
        $response = $this->put('/api/package/' . '63fc8d9cbc1f0000d7005bf7', $data);
        $response->assertStatus(200);
        
    }

    public function test_can_update_transaction_by_id_using_patch()
    {
        $data = [
            'transaction_id'=> 'd0090c40-539f-479a-8274-899b9970bddc',
            'customer_name'=> 'PT. AMARA PRIMATIGA',
